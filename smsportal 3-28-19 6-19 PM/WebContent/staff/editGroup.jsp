            ...
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/GroupSmsController" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                    	<c:set value="${sessionScope.groupNamesList}" var="groupNamesList"></c:set>
                      <input required="required" class="form-control" name="groupName" type="text" placeholder="Type Something.." value="${groupNamesList[0].groupName}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
       				  <div class="row">
       				    <select class="js-example-basic-multiple tagsinput" id="studentId" name="studentId" multiple="multiple" style="width: 100%; height: 75%;">
						
							<c:forEach var="studentList" items="${sessionScope.studentList}">
								<c:set var="flag" value="0"></c:set>
                      			
								<c:forEach var="groupMembersList" items="${sessionScope.groupMembersList}">
									
									<c:if test="${groupMembersList.studentId eq studentList.studentId}">
                      		...
                      		<c:when test="${flag eq 1}">
                      			<option selected value="${studentList.studentId}">${studentList.studentFirstName} ${studentList.studentEnrollmentNumber} ${studentList.classVO.className} ${studentList.branchVO.branchName}</option>
                      		</c:when>
                      		<c:otherwise>
                  ...
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="updateGroup">
                    		
                    		<input type="hidden" name="groupNameId" value="${groupNamesList[0].groupNameId}">
                               <input required="required" class="btn btn-primary" type="submit" value="Edit Group">
                    </div>
                    </div>
                    </form>
                </div>
