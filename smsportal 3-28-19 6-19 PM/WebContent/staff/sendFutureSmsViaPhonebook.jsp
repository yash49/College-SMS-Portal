          ...
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/FutureSmsController" method="post" onsubmit="return validateform();">
                  <h4 class="card-title">Send Future Sms Via Phonebook</h4>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
       				  <div class="row">
       				    <select class="js-example-basic-multiple tagsinput" required="required" name="mobileNumber" multiple="multiple" style="width: 100%; height: 75%;">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" class="form-control" maxlength="" name="dateTime" type="datetime-local" placeholder="Type Something..">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-lg-3">
                  ...
                  <div class="col-12" align="center">
                    		...
                    		<input required="required" type="hidden" name="flag" value="insertFutureSms">
                               ...
                               <input required="required" type="hidden" name="to" value="futureSmsViaPhonebook">
                    </div>
                    </div>
                    </form>
                </div>
