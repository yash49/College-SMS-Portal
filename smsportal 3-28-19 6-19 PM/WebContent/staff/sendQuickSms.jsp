          ...
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/QuickSmsController" method="post" onsubmit="return validateform();">
                  <h4 class="card-title">Quick SMS</h4>
                  <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Phone number</label>
                    </div>
                    <div class="col-lg-8">
                      <input required="required" id="mobile" class="form-control" onkeypress="javascript:return isNumber(event)" maxlength="10" minlength="10" name="mobileNumber" type="text" placeholder="Enter Mobile Number">
                    </div>
                  </div>
                  ...
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="sendQuickSms">
