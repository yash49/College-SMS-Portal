        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              			<div class="card">
                <div class="card-body">
               <form action="<%=request.getContextPath() %>/GroupSmsController" method="post" onsubmit="return validateform();">
                  <h4 class="card-title">Send Group SMS</h4>
                <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Group</label>
                    </div>
                    <div class="col-lg-8">
                      <select class="form-control" required="required" id="selectGroup" name="groupNameId">
                          	<option value="selectGroup">Select Group</option>
                          	<c:forEach items="${sessionScope.groupNameList}" var="x">
                          		<option value="${x.groupNameId}">${x.groupName}</option>
                          	</c:forEach>
                        </select>
                      </div>
                  </div>
                  ...
                  <div class="col-12" align="center">
                    		<br/>
                    		<input required="required" type="hidden" name="flag" value="sendGroupSms">
