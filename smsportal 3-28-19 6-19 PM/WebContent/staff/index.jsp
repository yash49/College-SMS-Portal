...
<%
	...
	ArrayList<Object[]> studentBranchList = AdminIndexDAO.getGraphData();

	for (Object[] objects : studentBranchList) {
		/* System.out.println(objects[0]);
		System.out.println(objects[1]); */
	
		%>
		
		<input type="hidden" name="xvalue" value="<%=objects[1]%>" />	
		<input type="hidden" name="yvalue" value="<%=objects[0]%>" />
        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-5 mb-4 mb-xl-0">
                  <h4 class="font-weight-bold">Hi, Welcomeback <%=StaffIndexDAO.getStaffName(loginVO) %> !</h4>
                  <h4 class="font-weight-normal mb-0">VPMP SMS Portal Dashboard ,</h4>
                </div>
         ...
         <div class="row">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left"><a href="<%=request.getContextPath()%>/staff/viewStudent.jsp">My Students</a></p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><%=StaffIndexDAO.getMyStudents(loginVO)%></h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left"><a href="<%=request.getContextPath()%>/staff/viewFutureSms.jsp">Pending Future SMS</a></p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">   <%=StaffIndexDAO.getPendingFutureSms(loginVO) %>   </h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left"><a href="<%=request.getContextPath()%>/staff/viewGroup.jsp">My Groups</a></p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"> <%=StaffIndexDAO.getMyGroup(loginVO) %> </h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left"><a href="<%=request.getContextPath()%>/staff/viewSmsTemplate.jsp">My SMS Templates</a></p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"> <%=StaffIndexDAO.getMySmsTemplates(loginVO) %> </h3>
                    <i class="ti-bookmark-alt icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                  </div>  
                </div>
              </div>
            </div>
 ...
 -->         
  ...
  <!-- container-scroller -->
<script src="<%=request.getContextPath() %>/admin/adminResources/js/highcharts.js"></script>
<script src="<%=request.getContextPath() %>/admin/adminResources/js/exporting.js"></script>
...
Highcharts.chart({
    ...
    title: {
        text: 'Numbers of Students in every Branch'
    },
    subtitle: {
        text: 'Each Bar represents Branch '
    },
    xAxis: {
        categories: xdata,
        crosshair: true
  ...
  <script src="../admin/adminResources/js/dashboard.js"></script>
