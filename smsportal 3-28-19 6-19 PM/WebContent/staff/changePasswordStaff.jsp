            ...
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/ForgotPasswordController"  method="post" onsubmit="return validatepwd();">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" minlength="6" class="form-control" name="oldPassword" type="text" placeholder="Enter current password">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" minlength="6" class="form-control" id="newPassword" name="newPassword" type="text" placeholder="Enter new password">
                    </div>
                  </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" minlength="6" class="form-control" id="confirmNewPassword" name="confirmNewPassword" type="text" placeholder="Confirm New password">
                      <br>
