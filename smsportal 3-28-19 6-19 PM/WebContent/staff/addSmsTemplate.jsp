          ...
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/SmsTemplateController" method="post">
                  <h4 class="card-title">Create SMS Template</h4>
                  <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Template Name</label>
                    </div>
                    <div class="col-lg-8">
                      <input class="form-control" required="required" name="smsTemplateName" type="text" placeholder="Enter SMS Template Name">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea name="smsTemplateText" required="required" id="maxlength-textarea" class="form-control" maxlength="160" rows="4" placeholder="Message has a limit of 160 chars."></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="insertSmsTemplate">
