...
<%
	...
	System.out.print("OOOOOOO  "+ls.size());
%>
<head>
  <!-- Required meta tags -->
                  ...
                  <div class="table-responsive">
                   ...
                   <c:forEach items="${sessionScope.list}" var="z">
						...
						<tr>
							<td>${z.classId}</td>
							<td>${z.className}</td>
							<td>${z.classDescription}</td>
							<td><a onclick="return confirm('Are you sure you want to delete this item?');" href="<%=request.getContextPath()%>/ClassController?classId=${z.classId}&flag=deleteClass">Delete</a></td>
							<td><a href="<%=request.getContextPath()%>/ClassController?classId=${z.classId}&flag=editClass">Edit</a></td>
						</tr>
					</c:forEach>
                    </table>
                  </div>
