            ...
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/ClassController" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" class="form-control" maxlength="25" name="className" type="text" placeholder="Enter Class Name">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="classDescription" class="form-control" rows="4" placeholder="Enter Class Description"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
