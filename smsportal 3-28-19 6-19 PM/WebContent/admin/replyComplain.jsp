          ...
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <c:forEach items="${sessionScope.complainList}" var="z">
                  <h4 class="card-title">Reply to Complain</h4>
                  <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Subject</label>
                    </div>
                    <div class="col-lg-8">
                      <input class="form-control" required="required" readonly="readonly" name="complainSubject" value="${z.complainSubject }" type="text" placeholder="Enter Sender ID">
            	...
            	<div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="complainDescription" id="maxlength-textarea" class="form-control" readonly="readonly" rows="2" >${z.complainDescription}</textarea>
                    </div>
                  </div>
                <div class="form-group row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="complainReply" id="maxlength-textarea" class="form-control" rows="2" >${z.complainReply}</textarea>
                    </div>
                  </div>  
                  ...
                  <div class="col-12" align="center">
                    		<br/>
           				<input type="hidden" name="complainId" value="${z.complainId}">
                    	<input type="hidden" name="complainDate" value="${z.complainDate}">
                    	<input type="hidden" name="complainReplyDate" value="${z.complainReplyDate}">
                    	<input type="hidden" name="complainStatus" value="${z.complainStatus}">
                    	<input type="hidden" name="complainFileName" value="${z.complainFileName}">
                    	<input type="hidden" name="complainFilePath" value="${z.complainFilePath}">
