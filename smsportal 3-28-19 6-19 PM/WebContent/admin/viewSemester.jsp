    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">View Semester</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                   ...
                   <c:forEach items="${sessionScope.list}" var="z">
						...
						<tr>
							<td>${z.semesterId}</td>
							<td>${z.semesterNumber}</td>
							<td><a onclick="return confirm('Are you sure you want to delete this item?');" href="<%=request.getContextPath()%>/SemesterController?semesterId=${z.semesterId}&flag=deleteSemester">Delete</a></td>
							<td><a href="<%=request.getContextPath()%>/SemesterController?semesterId=${z.semesterId}&flag=editSemester">Edit</a></td>
						</tr>
					</c:forEach>
                    </table>
                  </div>
