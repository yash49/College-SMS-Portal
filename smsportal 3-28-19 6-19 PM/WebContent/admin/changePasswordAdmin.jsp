        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              			<div class="card">
                <div class="card-body">
               <form action="<%=request.getContextPath() %>/ForgotPasswordController"  method="post" onsubmit="return validatepwd();">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input minlength="6" required="required" class="form-control" name="oldPassword" type="text" placeholder="Enter current password">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input minlength="6" required="required" class="form-control" id="newPassword" name="newPassword" type="text" placeholder="Enter new password">
                    </div>
                  </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input minlength="6" required="required" class="form-control" id="confirmNewPassword" name="confirmNewPassword" type="text" placeholder="Confirm New password">
        				...
        				if(isPasswordCorrect != null)
        					out.print("The Entered Current Password is not Valid");
