        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/DesignationController" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input class="form-control" required="required" name="designationName" type="text" placeholder="Type Something.." value="${z.designationName}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="designationDescription" class="form-control" rows="4" placeholder="This textarea has a limit of 100 chars.">${z.designationDescription}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="updateDesignation">
                    		<input type="hidden" name="designationId" value=${z.designationId}>
