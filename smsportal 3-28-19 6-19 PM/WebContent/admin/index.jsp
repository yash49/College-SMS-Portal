        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-5 mb-4 mb-xl-0">
                  <h4 class="font-weight-bold">Hi, Welcomeback Admin !</h4>
          ...
          <div class="row">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 <a href="viewStaffForHistory.jsp"> <p class="card-title text-md-center text-xl-left">Total SMS sent</p></a>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><%=AdminIndexDAO.getTotalSms() %></h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <a href="viewStaff.jsp"><p class="card-title text-md-center text-xl-left">Total Staffs</p></a>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><%=AdminIndexDAO.getTotalStaff() %></h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 <a href="viewComplain.jsp"> <p class="card-title text-md-center text-xl-left">Total Pending Complains</p></a>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><%=AdminIndexDAO.getTotalPendingComplains()%></h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <a href="viewSenderId.jsp"><p class="card-title text-md-center text-xl-left">Total SenderIDs</p></a>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><%=AdminIndexDAO.getTotalSenderId()%></h3>
