          ...
          <div class="row grid-margin">
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/SenderIdController" method="post">
                  <h4 class="card-title">Add Sender ID</h4>
                  <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Sender ID</label>
                    </div>
                    <div class="col-lg-8">
                      <input class="form-control" required="required" minlength="6" maxlength="6" name="senderIdName" type="text" placeholder="Enter Sender ID">
                    </div>
                  </div>
                  ...
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="insertSenderId">
