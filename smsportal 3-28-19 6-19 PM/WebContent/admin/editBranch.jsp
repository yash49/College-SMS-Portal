            ...
            <div class="col-12">
               ...
               <form action="<%=request.getContextPath() %>/BranchController" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" class="form-control" name="branchName" type="text" placeholder="Enter Branch Name" value="${z.branchName}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="branchDescription" class="form-control" rows="4" placeholder="Enter Branch Description">${z.branchDescription}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="updateBranch">
                    		<input type="hidden" name="branchId" value=${z.branchId}>
