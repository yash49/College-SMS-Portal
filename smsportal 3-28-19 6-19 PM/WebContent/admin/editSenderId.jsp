        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-12">
              			<div class="card">
                <div class="card-body">
               <form action="<%=request.getContextPath() %>/SenderIdController" method="post">
               <c:forEach items="${sessionScope.senderIdList}" var="z">
                  <h4 class="card-title">Edit Sender ID</h4>
                  <div class="form-group row">
                    <div class="col-lg-3">
                      <label class="col-form-label">Sender ID</label>
                    </div>
                    <div class="col-lg-8">
                      <input class="form-control" required="required" maxlength="6" minlength="6" name="senderIdName" value="${z.senderIdName }" type="text" placeholder="Enter Sender ID">
                    	<input type="hidden" name="senderId" value="${z.senderId}">
                    </div>
                  </div>
                  ...
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="updateSenderId">
