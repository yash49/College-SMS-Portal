            ...
            <div class="col-12">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input required="required" class="form-control" name="designationName" type="text" placeholder="Enter Designation Name">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <textarea required="required" name="designationDescription" class="form-control"  rows="4" placeholder="Enter Designation Description"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  <div class="col-12" align="center">
                    		<br/>
                    		<input type="hidden" name="flag" value="insertDesignation">
