    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">View Sender ID</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                   ...
                   <c:forEach items="${sessionScope.senderIdList}" var="z">
						...
						<tr>
							<td>${z.senderId}</td>
							<td>${z.senderIdName}</td>
							<td><a onclick="return confirm('Are you sure you want to delete this item?');" href="<%=request.getContextPath()%>/SenderIdController?senderId=${z.senderId}&flag=deleteSenderId">Delete</a></td>
							<td><a href="<%=request.getContextPath()%>/SenderIdController?senderId=${z.senderId}&flag=editSenderId">Edit</a></td>
						</tr>
					</c:forEach>
                    </table>
                  </div>
